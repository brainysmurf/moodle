...
echo $OUTPUT->sign('rocket', 'All Secondary Activities', 'This page shows all the activities currently available for selection. Click on an Activity you would like to supervise. <br /><strong class="red">Red</strong> means that activity already has enough supervisors, <strong class="green">green</strong> means there are spaces available. <strong class="blue">Blue</strong> means that you are listed as supervising it.');
