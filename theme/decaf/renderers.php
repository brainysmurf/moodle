...
class theme_decaf_core_renderer extends core_renderer {
   ...
   /* function render_tabtree(tabtree $tabtree) {
        ...
        $str = '';
        $str .= html_writer::start_tag('div', array('class' => 'bs-navbar'));
        	$str .= html_writer::start_tag('div', array('class' => 'bs-navbar-inner'));
   ...
   /* function render_tabobject(tabobject $tabobject) {
        ...
        else if ($tabobject->inactive || $tabobject->activated || ($tabobject->selected && !$tabobject->linkedwhenselected))
        {
            ...
            $str .= html_writer::tag('a', $tabobject->text, array('class' => 'nolink'));
        }
        else
        {
            ...
            if ( !($tabobject->link instanceof moodle_url) )
            {
                ...
                $str .= "<a href=\"$tabobject->link\" title=\"$tabobject->title\">$tabobject->text</a>";
            }
            else
            {
        ...
        // Print subtree
        $str .= html_writer::start_tag('ul', array('class' => 'bs-nav'));
        $cnt = 0;
