...
{	
	...
	*	Settings
	*/
	var menuShowDelay = 1000; //How long (in milliseconds) to wait before showing a menu
	var menuHideDelay = 1000; //How long (in milliseconds) to keep menus open for after mouse leaves them
