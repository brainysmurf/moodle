...
$string['hideeditortoolbar'] = 'Hide editing tools<i class="icon-chevron-sign-up pull-right" />';
$string['hour'] = 'Hour';
$string['minute'] = 'Minute';
$string['miscellaneoussettings'] = 'Miscellaneous settings';
$string['modstandardels'] = 'General settings';
$string['month'] = 'Month';
...
$string['showeditortoolbar'] = 'Show editing tools<i class="icon-chevron-sign-down pull-right" />';
