...
$string['activities'] = 'Frequently Used';
...
$string['activityclipboard'] = '<strong>You are moving this activity:</strong> {$a}';
...
$string['addresourceoractivity'] = 'Add something to this course';
$string['addresourcetosection'] = 'Add a resource to section \'{$a}\'';
$string['address'] = 'Bus Route Information';
...
$string['deletesectioncheck'] = 'Are you sure you want to delete section {$a}? All activities and resources within this section will be deleted. This is NOT the same as hiding the section - all resouces will be deleted and this cannot be undone!';
...
$string['forgotten'] = 'Reset my password';
...
$string['nothingtodisplay'] = 'There are no items with these search parameters, select "all" above.';
...
$string['phone'] = 'Bus Morning Route';
$string['phone2'] = 'Bus Afternoon Route';
...
$string['savechangesanddisplay'] = 'Save and continue';
...
$string['searchbyemail'] = '...or, by email address';
$string['searchbyusername'] = 'By username...';
...
$string['someallowguest'] = '<icon class="icon-question-sign" /> No DragonNet login?';
...
$string['yahooid'] = 'Bus Transport ID';
$string['year'] = 'year';
$string['years'] = 'years';
$string['yes'] = 'Yes';
