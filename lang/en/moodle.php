...
$string['department'] = 'Front Page Redirect';
...
$string['passwordforgotteninstructions2'] = 'To reset your password:<br />Submit either your username <b>or</b> your email address below. If DragonNet finds the information in the database, instructions will be sent to the email address associated with your account.';
...
$string['someallowguest'] = '<icon class="icon-question-sign" /> Were you directed here but you do not have a DragonNet login?';
