...
$string['course'] = 'Class';
$string['courseevent'] = 'Class event';
$string['courseevents'] = 'Class events';
$string['courses'] = 'Class';
$string['daily'] = 'Daily';
...
$string['global'] = 'SSIS';
$string['globalevent'] = 'SSIS event';
$string['globalevents'] = 'SSIS events';
$string['gotocalendar'] = 'Go to calendar';
$string['group'] = 'Group';
$string['groupevent'] = 'Group event';
$string['groupevents'] = 'Group events';
$string['hidden'] = 'hidden';
$string['hidecourseevents'] = 'Hide class events';
$string['hideglobalevents'] = 'Hide SSIS events';
...
$string['showcourseevents'] = 'Show class events';
$string['showglobalevents'] = 'Show SSIS events';
...
$string['tt_showcourse'] = 'Class events are hidden (click to show)';
$string['tt_showglobal'] = 'SSIS events are hidden (click to show)';
