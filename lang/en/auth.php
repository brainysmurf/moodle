...
$string['errorminpasswordnonalphanum'] = 'Passwords must have at least {$a} non-alphanumeric character(s).在密码后面加上一个符号字(比如数字键上的符号如!) 드레곤넷 암호를 만들때는 문자나 숫자와 함께 기호가 꼭 들어가야 합니다. Shift 키를 눌러서 숫자위에 나온 기호를 (예: !, @, #) 입력하세요.';
