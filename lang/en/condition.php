...
$string['isempty'] = 'is empty / is checked';
$string['isequalto'] = 'is equal to';
$string['isnotempty'] = 'is not empty / is not checked';
$string['none'] = '(none)';
...
$string['requires_date'] = 'Only available from {$a}.';
$string['requires_date_before'] = 'Only available until {$a}.';
$string['requires_date_both'] = 'Only available from {$a->from} to {$a->until}.';
$string['requires_date_both_single_day'] = 'Only available on {$a}.';
...
$string['requires_user_field_contains'] = 'Not available unless your <strong>{$a->field}</strong> field contains <strong>{$a->value}</strong>.';
$string['requires_user_field_doesnotcontain'] = 'Not available if user\'s <strong>{$a->field}</strong> field contains <strong>{$a->value}</strong>.';
$string['requires_user_field_endswith'] = 'Not available unless user\'s <strong>{$a->field}</strong> field ends with <strong>{$a->value}</strong>.';
$string['requires_user_field_isempty'] = 'Not available unless user\'s <strong>{$a->field}</strong> field is empty.';
$string['requires_user_field_isequalto'] = 'Not available unless user\'s <strong>{$a->field}</strong> field is equal to <strong>{$a->value}</strong>.';
$string['requires_user_field_isnotempty'] = 'Only available to <strong>{$a->field}s</strong>.';
$string['requires_user_field_startswith'] = 'Not available unless your <strong>{$a->field}</strong> field starts with <strong>{$a->value}</strong>.';
...
$string['userrestriction_hidden'] = 'Hidden: &lsquo;{$a}&rsquo;';
$string['userrestriction_visible'] = 'Restriction: &lsquo;{$a}&rsquo;';
